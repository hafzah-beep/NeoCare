  ...
  const cancelAppointment = async () => {
    ...
    try {
      ...
      const res = await api.put(
        `/admin/appointments/${selectedAppointment._id}/cancel`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      alert(res.data.message || "Appointment berhasil dibatalkan");
      await getAppointments();
    } catch (error) {
      console.log(error);
      alert(
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          <div>
            ...
            <p className="text-muted mb-0">
              Pantau appointment pasien dan dokter
            </p>
          </div>
              ...
              <div className="card-body p-4">
                ...
                {!selectedAppointment ? (
                  ...
                  <>
                    ...
                    <div className="mb-3">
                      <small className="text-muted">Dokter</small>
                    ...
                    <div className="mb-3">
                      <small className="text-muted">Keluhan</small>
                      <p className="fw-semibold mb-0">
                    ...
                    <div className="mb-4">
                      <small className="text-muted">Dokumen Pendukung</small>
                    ...
                    {canCancel ? (
                      ...
                      >
                        {actionLoading ? "Memproses..." : "Batalkan Appointment"}
                      </button>
                    ) : (
                      <div
                      ...
                      >
                        Appointment ini tidak dapat dibatalkan.
                      </div>
                    )}
                  </>
                )}
